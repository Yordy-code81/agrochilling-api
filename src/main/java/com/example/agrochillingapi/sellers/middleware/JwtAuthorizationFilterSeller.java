...
import com.example.agrochillingapi.sellers.service.SellerServiceImpl;
...
public class JwtAuthorizationFilterSeller extends OncePerRequestFilter {

    private static final Logger logger = LoggerFactory.getLogger(JwtAuthorizationFilterSeller.class);

    @Autowired
    private JwtHandlerSeller handler;

    @Autowired
    private SellerServiceImpl userService;
