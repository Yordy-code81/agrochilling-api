...
@Component
public class JwtHandlerSeller {

    private static final Logger logger = LoggerFactory.getLogger(JwtHandlerSeller.class);
    ...
    public String generateToken(Authentication authentication) {
        ...
        String subject = ((SellerDetailsImpl) authentication.getPrincipal()).getEmail();
